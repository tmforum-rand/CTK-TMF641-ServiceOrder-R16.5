...
Once Node.js and npm are installed download and unzip the CTK-TMF641-ServiceOrdering ZIP file within your test directory.
...
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceOrdering/v3/serviceOrder

You should input:
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceOrdering/v3/
...
![CTK Example Image](images/Output-Example.png)
