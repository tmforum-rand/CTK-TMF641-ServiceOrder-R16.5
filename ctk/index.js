...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceOrdering/v3/";
var schema;
var hostname;
var port;
...
console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF641 ServiceOrdering\n");
getURL();
...
function getURL(){
    ...
    'https://tmf641-serviceordering-r165.mybluemix.net/tmf-api/orderManagement/2.0/serviceOrder\n'+
    'becomes\n'+
    'https://tmf641-serviceordering-r165.mybluemix.net/tmf-api/orderManagement/2.0/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF641-ServiceOrdering.postman_collection.json'),
